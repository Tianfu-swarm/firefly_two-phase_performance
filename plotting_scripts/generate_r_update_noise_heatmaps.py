...
for noise_level in [0.0]:  # ,0.05, 0.1, 0.2
    ...
    for N in Ns:
        ...
        for C in Cs:
            ...
            try:
                path = f'r_com_range_experiments/flash_proportion=0.5_qr_threshold=0.5_update_noise={noise_level}/N={N}_C={C}_T=10000_r_com_range_flash_counts.pkl'
    ...
    heatmap_path = f'heatmap_noise_lower_phase_{noise_level}.npz'
